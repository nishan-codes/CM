...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "h-full border border-border px-4 py-4 hidden md:flex md:flex-col w-[300px] shrink-0",
          className
        )}
        animate={{
...
export const MobileSidebar = ({
  ...
  return (
    <>
      <div
        className={cn(
          "fixed z-5000 top-0 h-10 pl-5 pr-6 py-4 flex flex-row md:hidden items-center justify-between bg-neutral-100 dark:bg-neutral-800 w-full"
        )}
        {...props}
      >
